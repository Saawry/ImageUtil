...
import com.gadware.android.cropimage.CropImageView.CropShape
import com.gadware.android.cropimage.CropImageView.Guidelines
...
@Parcelize data class CropImageOptions @JvmOverloads constructor(
  ...
  @JvmField var fixAspectRatio: Boolean = true,//false
  ...
  init {
    ...
    require(initialCropWindowPaddingRatio in 0.0..<0.5) { "Cannot set initial crop window padding value to a number < 0 or >= 0.5" }
    ...
    require(rotationDegrees in 0..DEGREES_360) { "Cannot set rotation degrees value to a number < 0 or > 360" }
  }
}
