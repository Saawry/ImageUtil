...
import com.gadware.android.cropimage.CropOverlayView.CropWindowChangeListener
      ...
      ?: if (attrs != null) {
        ...
        try {
          ...
          CropImageOptions(
            ...
            ) || a.hasValue(R.styleable.CropImageView_cropAspectRatioX) && a.hasValue(R.styleable.CropImageView_cropAspectRatioX),
          )
        } finally {
          a.recycle()
        }
